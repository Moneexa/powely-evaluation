...
<template>
    <div class="flex flex-col items-start p-2 md:p-5">
        ...
        <div class="bg-white flex-column px-3 pt-3 pb-2 my-2 w-full">
            <div class="flex md:flex-row items-start">
                <form @submit="handleSubmit" class="flex flex-col md:flex-row items-center grow gap-2">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex">
                            ...
                            <button class="uppercase  focus:bg-green-500 focus:text-white focus:outline-none rounded-full"
                    ...
                    <button type="submit" class="px-0.5 py-0.5 bg-red rounded-0">ADD</button>
